...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210531_mundogenshinimpact_ee349ad69b698f363004_20210602212042_archive.zip';
	const ARCHIVE_SIZE		 = '52667001';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ee349ad-02212042';
    const SECONDARY_PACKAGE_HASH = 'a3d2be7-02212042';
	const VERSION			 = '1.4.1';
