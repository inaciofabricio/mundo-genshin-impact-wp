...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210531_mundogenshinimpact_95d760670c99ec842141_20210531210252_archive.zip';
	const ARCHIVE_SIZE		 = '158758425';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '95d7606-31210252';
    const SECONDARY_PACKAGE_HASH = 'a059cbe-31210252';
	const VERSION			 = '1.4.1';
